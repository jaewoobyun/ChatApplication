...
//        print(loginRegisterSegmentedControl.selectedSegmentIndex)
	...
	//FIXME: pressing enter(return) to press login/register button logic.
    ...
    func setupInputsContaierView() {
        //need x, y, width, height constraints
        inputsContainerView.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
        inputsContainerView.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: 1).isActive = true
